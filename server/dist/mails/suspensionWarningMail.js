...
exports.sendSuspensionWarningMail = void 0;
const mailSettings_1 = require("../config/mailSettings");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
const sendSuspensionWarningMail = (username, email, token) => __awaiter(void 0, void 0, void 0, function* () {
    const mailOptions = {
...
exports.sendSuspensionWarningMail = sendSuspensionWarningMail;
